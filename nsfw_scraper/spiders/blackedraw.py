...
base_uri = "https://blackedraw.com"

class BlackedRawSpider(Spider):
    name = "blackedraw"
    allowed_domains = ["blackedraw.com"]
    start_urls = [
        "https://blackedraw.com/videos"
    ]
    ...
    def parse(self, response):
        ...
        for page_num in range(1, int(page_num)+1):
            yield scrapy.Request(url=f"https://www.blackedraw.com/videos?page={page_num}&size=12", callback=self.parse)
    ...
    def parse_scene(self, response):
        ...
        item['studio'] = 'Blacked Raw'
        item['parent_studio'] = 'Blacked'
