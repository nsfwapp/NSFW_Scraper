...
base_uri = "https://tushy.com"

class TushySpider(Spider):
    name = "tushy"
    allowed_domains = ["tushy.com"]
    start_urls = [
        "https://tushy.com/videos"
    ]
    ...
    def parse(self, response):
        ...
        for page_num in range(1, int(page_num)+1):
            yield scrapy.Request(url=f"https://www.tushy.com/videos?page={page_num}&size=12", callback=self.parse)
