...
base_uri = "https://deeper.com"

class DeeperSpider(Spider):
    name = "deeper"
    allowed_domains = ["deeper.com"]
    start_urls = [
        "https://deeper.com/videos"
    ]
    ...
    def parse(self, response):
        ...
        for page_num in range(1, int(page_num)+1):
            yield scrapy.Request(url=f"https://www.deeper.com/videos?page={page_num}&size=12", callback=self.parse)
