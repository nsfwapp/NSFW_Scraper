...
base_uri = "https://tushyraw.com"

class TushyRawSpider(Spider):
    name = "tushyraw"
    allowed_domains = ["tushyraw.com"]
    start_urls = [
        "https://tushyraw.com/videos"
    ]
    ...
    def parse(self, response):
        ...
        for page_num in range(1, int(page_num)+1):
            yield scrapy.Request(url=f"https://www.tushyraw.com/videos?page={page_num}&size=12", callback=self.parse)
    ...
    def parse_scene(self, response):
        ...
        item['studio'] = 'Tushy Raw'
        item['parent_studio'] = 'Tushy'
